...
<head>
  ...
  <title>Sanad Center - Bootstrap 5 Recreation</title>
    ...
    <div class="container-xxl">
      ...
      <div class="collapse navbar-collapse" id="mainNavbar">
        <ul class="navbar-nav mx-auto mb-2 mb-lg-0 gap-lg-3">
          <li class="nav-item"><a class="nav-link fw-semibold" href="#home">الرئيسية</a></li>
          <li class="nav-item"><a class="nav-link fw-semibold" href="#about">من نحن</a></li>
          <li class="nav-item"><a class="nav-link fw-semibold" href="#services">خدماتنا</a></li>
          <li class="nav-item"><a class="nav-link fw-semibold" href="#specialists">الأخصائيون</a></li>
          <li class="nav-item"><a class="nav-link fw-semibold" href="#programs">البرامج</a></li>
          <li class="nav-item"><a class="nav-link fw-semibold" href="#contact">تواصل معنا</a></li>
        </ul>
        <div class="d-flex align-items-center gap-2 mt-3 mt-lg-0">
          <button class="btn btn-brand-outline rounded-pill px-4 d-flex align-items-center gap-2">
          ...
          <button class="btn btn-brand-primary rounded-pill px-4 d-flex align-items-center gap-2">
      ...
      <div class="container-xxl py-md-5">
        ...
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
          ...
          <div class="col">
            <div class="card h-100 shadow-sm border-0 card-hover overflow-hidden">
                <div class="overflow-hidden img-zoom-hover" style="height: 300px;">
                    <img src="https://images.unsplash.com/photo-1557862921-37829c790f19?q=80&w=2071&auto=format&fit=crop" class="card-img-top h-100 w-100 object-fit-cover" alt="د. أحمد العبدالله">
                </div>
                <div class="card-body text-center p-4">
                    <h3 class="card-title fs-3">د. أحمد العبدالله</h3>
                    <p class="card-text text-secondary-emphasis fs-5">أخصائي نفسي</p>
                    <p class="text-muted">10 سنوات خبرة</p>
                    <a href="#" class="btn btn-brand-primary rounded-pill px-5 py-2 mt-2">احجز الآن</a>
                </div>
            </div>
          </div>
          <!-- Specialist 2 -->
          <div class="col">
             <div class="card h-100 shadow-sm border-0 card-hover overflow-hidden">
                <div class="overflow-hidden img-zoom-hover" style="height: 300px;">
                    <img src="https://images.unsplash.com/photo-1557862921-37829c790f19?q=80&w=2071&auto=format&fit=crop" class="card-img-top h-100 w-100 object-fit-cover" alt="سارة الخطيب">
                </div>
                <div class="card-body text-center p-4">
                    <h3 class="card-title fs-3">سارة الخطيب</h3>
                    <p class="card-text text-secondary-emphasis fs-5">أخصائية اجتماعية</p>
                    <p class="text-muted">8 سنوات خبرة</p>
                    <a href="#" class="btn btn-brand-primary rounded-pill px-5 py-2 mt-2">احجز الآن</a>
                </div>
            </div>
          </div>
          ...
          <div class="col">
             <div class="card h-100 shadow-sm border-0 card-hover overflow-hidden">
                <div class="overflow-hidden img-zoom-hover" style="height: 300px;">
                    <img src="https://images.unsplash.com/photo-1557862921-37829c790f19?q=80&w=2071&auto=format&fit=crop" class="card-img-top h-100 w-100 object-fit-cover" alt="د. محمد السعيد">
                </div>
                <div class="card-body text-center p-4">
                    <h3 class="card-title fs-3">د. محمد السعيد</h3>
                    <p class="card-text text-secondary-emphasis fs-5">مستشار أسري</p>
                    <p class="text-muted">12 سنة خبرة</p>
                    <a href="#" class="btn btn-brand-primary rounded-pill px-5 py-2 mt-2">احجز الآن</a>
                </div>
            </div>
          </div>
    ...
    <section id="programs" class="py-5 bg-soft-gradient">
        <div class="container">
          ...
          <div class="row justify-content-center g-4">
            ...
            <!-- Program 2 -->
            <div class="col-md-6 col-lg-4">
              <div class="card card-hover border shadow-sm animate-scale-in" style="animation-delay: 0.1s;">
                <img src="/assets/weekly-support-B9Vumwn6.jpg" class="card-img-top" alt="مهارات التواصل الفعال">
                <div class="card-body">
                  <div class="mb-4">
                    <!-- Bouncing SVG Circle -->
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="step-circle d-flex align-items-center justify-content-center rounded-circle shadow-lg mb-4 animate-bounce-slow" 
                          style="background: linear-gradient(135deg, #3b82f6, #1d4ed8); width: 4rem; height: 4rem;">
                          <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-heart text-white" aria-hidden="true">
                            <path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"></path>
                          </svg>
                        </div>
                        <div>
                            <span class="custom-badge custom-warning">حضوري</span>
                        </div>
                    </div>
                  </div>
                  <h5 class="card-title font-semibold text-2xl mb-2">مهارات التواصل الفعال</h5>
                  <p class="card-text text-muted">برنامج لتحسين مهارات التواصل والعلاقات الاجتماعية.</p>
                  <div class="mb-3">
                    <div class="d-flex align-items-center gap-2 text-gray-600">
                      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-calendar">
                        <path d="M8 2v4"></path>
            ...
            <!-- More programs can be added here similarly -->
          </div> <!-- .row -->
        </div> <!-- .container -->
    </section>
    ...
    <div class="container-xxl">
        <div class="row g-4 mb-4">
            <div class="col-lg-3 col-md-6">
                <img src="assets/logo-It0L1yo6.png" alt="سند" class="mb-3" style="height: 4rem;">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <ul class="list-unstyled">
                    ...
                    <li class="mb-2"><a href="#services" class="text-white-50 text-decoration-none">خدماتنا</a></li>
                    <li><a href="#programs" class="text-white-50 text-decoration-none">البرامج</a></li>
                </ul>
            </div>
            <div class="col-lg-3 col-md-6">
        ...
        <div class="border-top border-secondary-subtle pt-4 mt-4 text-center text-white-50">
            <p>&copy; 2025 مركز سند. جميع الحقوق محفوظة.</p>
        </div>
    </div>
  </footer>
